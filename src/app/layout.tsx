  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        {/* Header */}
        <header className="w-full py-4 flex flex-col items-center justify-center bg-black z-50 text-white">
          <Image
            src="/images/logo.png"
          ...
          />
          <nav className="flex space-x-6 text-lg font-bold uppercase tracking-wide md:text-base">
            <Link href="/">Home</Link>
